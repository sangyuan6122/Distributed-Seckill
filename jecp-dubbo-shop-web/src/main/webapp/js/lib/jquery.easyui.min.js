 ...
 *
 */
/*3518行loadingMessage:"Loading..."去掉了Loading...
 *3529行——3535行增加<div class="loading" style="position: relative; z-index: 1000; top: 0px; left: 0px; width: 100%; height: 100%; background: #DDDDDB; text-align: center;"></div>
 *3535行主要用于parser前增加不透明div，当控件为tabs左边距加10px,顶部加40px,否则不加
 * */
