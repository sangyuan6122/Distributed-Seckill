...
<<<<<<< .mine
 *2470行这句cc.push("<span class=\"tree-indent\"></span>")注释了，因为树展开有错位，
 *3447行loadingMessage:"Loading..."去掉了 Loading...
 *3455-3461行增加<div class="loading" style="position: relative; z-index: 1000; top: 0px; left: 0px; width: 100%; height: 100%; background: #DDDDDB; text-align: center;"></div>
 *3461行主要用于parser前增加不透明div，当控件为tabs左边距加10px,顶部加40px,否则不加
 *
 *
 *
>>>>>>> .r111
...
var loadingdiv='';
if(opts.bodyCls!=null&&opts.bodyCls.indexOf('window-body')>-1){
	loadingdiv='<div class="loading" style="position: absolute; z-index: 1000; width: 100%; height: 100%; background: #eaeaea; text-align: center;box-sizing:content-box;"><div class="datagrid-mask-msg" style="display:block;left:42%;top:42%;">正在加载，请稍后...</div></div>';
}else{
	loadingdiv='<div class="loading" style="position: absolute; z-index: 1000; top: 41px; left: 10px; width: 100%; height: 100%; background: #eaeaea; text-align: center;box-sizing:content-box;"><div class="datagrid-mask-msg" style="display:block;left:42%;top:42%;">正在加载，请稍后...</div></div>';
}
_26b(loadingdiv+data);
},error:function(){
