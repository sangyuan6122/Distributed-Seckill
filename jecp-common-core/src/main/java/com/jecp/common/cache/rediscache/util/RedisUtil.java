...
public class RedisUtil {
    ...
    public RedisTemplate getRedisTemplate() {
		return RedisUtil.redisUtil.redisTemplate;
	}
    ...
    public static void set(String key,String value){
        RedisUtil.redisUtil.redisTemplate.opsForValue().set(key, value);
    }
    ...
    public static String get(String key){
        return (String) RedisUtil.redisUtil.redisTemplate.opsForValue().get(key);
    }
    ...
    public static void setForTimeMS(String key,String value,long time){
        RedisUtil.redisUtil.redisTemplate.opsForValue().set(key, value, time, TimeUnit.MILLISECONDS);
    }
    ...
    public static void setForTimeMIN(String key,String value,long time){
        RedisUtil.redisUtil.redisTemplate.opsForValue().set(key, value, time, TimeUnit.MINUTES);
    }
    ...
    public static void setForTimeCustom(String key,String value,long time,TimeUnit type){
        RedisUtil.redisUtil.redisTemplate.opsForValue().set(key, value, time, type);
    }
    ...
    public static String getAndSet(String key,String value){
        return (String) RedisUtil.redisUtil.redisTemplate.opsForValue().getAndSet(key, value);
    }
    ...
    public static void batchSet(Map<String,String> keyAndValue){
        RedisUtil.redisUtil.redisTemplate.opsForValue().multiSet(keyAndValue);
    }
    ...
    public static void batchSetIfAbsent(Map<String,String> keyAndValue){
        RedisUtil.redisUtil.redisTemplate.opsForValue().multiSetIfAbsent(keyAndValue);
    }
    ...
    public static Long increment(String key,long number){
        return RedisUtil.redisUtil.redisTemplate.opsForValue().increment(key, number);
    }
    ...
    public static boolean expire(String key,long time,TimeUnit type){
        return RedisUtil.redisUtil.redisTemplate.boundValueOps(key).expire(time, type);
    }
    ...
    public static boolean persist(String key){
        return RedisUtil.redisUtil.redisTemplate.boundValueOps(key).persist();
    }
    ...
    public static Long getExpire(String key){
        return RedisUtil.redisUtil.redisTemplate.boundValueOps(key).getExpire();
    }
    ...
    public static void rename(String key,String newKey){
        RedisUtil.redisUtil.redisTemplate.boundValueOps(key).rename(newKey);
    }
    ...
    public static boolean delete(String key){
        return RedisUtil.redisUtil.redisTemplate.delete(key);
    }
    ...
    public static void put(String key, String hashKey, String value){
        RedisUtil.redisUtil.redisTemplate.opsForHash().put(key, hashKey, value);
    }
    ...
    public static void putAll(String key,Map<String,String> map){
        RedisUtil.redisUtil.redisTemplate.opsForHash().putAll(key, map);
    }
    ...
    public static boolean putIfAbsent(String key, String hashKey, String value){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().putIfAbsent(key, hashKey, value);
    }
    ...
    public static Long delete(String key, String ...hashKeys){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().delete(key, hashKeys);
    }
    ...
    public static Long increment(String key, String hashKey,long number){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().increment(key, hashKey, number);
    }
    ...
    public static Object getHashKey(String key,String hashKey){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().get(key, hashKey);
    }
    ...
    public static Map<Object,Object> getHashEntries(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().entries(key);
    }
    ...
    public static boolean hashKey(String key,String hashKey){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().hasKey(key, hashKey);
    }
    ...
    public static Set<Object> hashKeys(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().keys(key);
    }
    ...
    public static Long hashSize(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForHash().size(key);
    }
    ...
    public static Long leftPush(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForList().leftPush(key, value);
    }
    ...
    public static Object leftPop(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForList().leftPop(key);
    }
    ...
    public static Long leftPushAll(String key,Collection<Object> values){
        return RedisUtil.redisUtil.redisTemplate.opsForList().leftPushAll(key, values);
    }
    ...
    public static Long rightPush(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForList().rightPush(key, value);
    }
    ...
    public static Object rightPop(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForList().rightPop(key);
    }
    ...
    public static Long rightPushAll(String key,Collection<Object> values){
        return RedisUtil.redisUtil.redisTemplate.opsForList().rightPushAll(key, values);
    }
    ...
    public static Object popIndex(String key,long index){
        return RedisUtil.redisUtil.redisTemplate.opsForList().index(key, index);
    }
    ...
    public static Long listSize(String key,long index){
        return RedisUtil.redisUtil.redisTemplate.opsForList().size(key);
    }
    ...
    public static List<Object> listRange(String key,long start,long end){
        return RedisUtil.redisUtil.redisTemplate.opsForList().range(key, start, end);
    }
    ...
    public static Long listRemove(String key,long count,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForList().remove(key, count, value);
    }
    ...
    public static void listTrim(String key,long start,long end){
        RedisUtil.redisUtil.redisTemplate.opsForList().trim(key, start, end);
    ...
    public static Object rightPopAndLeftPush(String key,String key2){
        return RedisUtil.redisUtil.redisTemplate.opsForList().rightPopAndLeftPush(key, key2);
    ...
    public static Long add(String key ,String ...values){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().add(key, values);
    }
    ...
    public static Set<Object> difference(String key ,String otherkey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().difference(key, otherkey);
    }
    ...
    public static Set<Object> difference(String key ,Collection<Object> otherKeys){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().difference(key, otherKeys);
    }
    ...
    public static Long differenceAndStore(String key ,String otherkey,String newKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().differenceAndStore(key, otherkey, newKey);
    }
    ...
    public static Long differenceAndStore(String key,Collection<Object> otherKeys,String newKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().differenceAndStore(newKey, otherKeys, newKey);
    }
    ...
    public static Long remove(String key,Object ...values){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().remove(key, values);
    }
    ...
    public static Object randomSetPop(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().pop(key);
    }
    ...
    public static Object randomSet(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().randomMember(key);
    }
    ...
    public static List<Object> randomSet(String key,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().randomMembers(key, count);
    }
    ...
    public static Set<Object> randomSetDistinct(String key,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().distinctRandomMembers(key, count);
    }
    ...
    public static boolean moveSet(String key,Object value,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().move(key, value, destKey);
    }
    ...
    public static Long setSize(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().size(key);
    }
    ...
    public static boolean isMember(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().isMember(key, value);
    }
    ...
    public static Set<Object> unionSet(String key,String otherKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().union(key, otherKey);
    }
    ...
    public static Set<Object> unionSet(String key,Collection<Object> otherKeys){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().union(key, otherKeys);
    }
    ...
    public static Long unionAndStoreSet(String key, String otherKey,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().unionAndStore(key, otherKey, destKey);
    }
    ...
    public static Long unionAndStoreSet(String key, Collection<Object> otherKeys,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().unionAndStore(key, otherKeys, destKey);
    }
    ...
    public static Set<Object> members(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForSet().members(key);
    }
    ...
    public static boolean add(String key,Object value,double score){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().add(key, value, score);
    }
    ...
    public static Long batchAddZset(String key,Set<TypedTuple<Object>> tuples){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().add(key, tuples);
    }
    ...
    public static Long removeZset(String key,String ...values){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().remove(key, values);
    }
    ...
    public static Double incrementScore(String key,Object value,double score){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().incrementScore(key, value, score);
    }
    ...
    public static Long rank(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rank(key, value);
    }
    ...
    public static Long reverseRank(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRank(key, value);
    }
    ...
    public static Set<TypedTuple<Object>> rangeWithScores(String key, long start, long end){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rangeWithScores(key, start, end);
    }
    ...
    public static Set<Object> range(String key, long start, long end){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().range(key, start, end);
    }
    ...
    public static Set<Object> rangeByScore(String key, double min, double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rangeByScore(key, min, max);
    }
    ...
    public static Set<TypedTuple<Object>> rangeByScoreWithScores(String key, double min, double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rangeByScoreWithScores(key, min, max);
    }
    ...
    public static Set<Object> rangeByScore(String key, double min, double max,long offset,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rangeByScore(key, min, max, offset, count);
    }
    ...
    public static Set<TypedTuple<Object>> rangeByScoreWithScores(String key, double min, double max,long offset,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().rangeByScoreWithScores(key, min, max, offset, count);
    }
    ...
    public static Set<Object> reverseRange(String key,long start,long end){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRange(key, start, end);
    }
    ...
    public static Set<TypedTuple<Object>> reverseRangeWithScores(String key,long start,long end){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRangeWithScores(key, start, end);
    }
    ...
    public static Set<Object> reverseRangeByScore(String key,double min,double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRangeByScore(key, min, max);
    }
    ...
    public static Set<TypedTuple<Object>> reverseRangeByScoreWithScores(String key,double min,double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRangeByScoreWithScores(key, min, max);
    }
    ...
    public static Set<Object> reverseRangeByScore(String key,double min,double max,long offset,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRangeByScore(key, min, max, offset, count);
    }
    ...
    public static Set<TypedTuple<Object>> reverseRangeByScoreWithScores(String key,double min,double max,long offset,long count){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().reverseRangeByScoreWithScores(key, min, max, offset, count);
    }
    ...
    public static long countZSet(String key,double min,double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().count(key, min, max);
    }
    ...
    public static long sizeZset(String key){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().size(key);
    }
    ...
    public static Double score(String key,Object value){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().score(key, value);
    }
    ...
    public static Long removeRange(String key,long start ,long end){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().removeRange(key, start, end);
    }
    ...
    public static Long removeRangeByScore(String key,double min ,double max){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().removeRangeByScore(key, min, max);
    }
    ...
    public static Long unionAndStoreZset(String key,String otherKey,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().unionAndStore(key, otherKey, destKey);
    }
    ...
    public static Long unionAndStoreZset(String key,Collection<String> otherKeys,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().unionAndStore(key, otherKeys, destKey);
    }
    ...
    public static Long intersectAndStore(String key,String otherKey,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().intersectAndStore(key, otherKey, destKey);
    }
    ...
    public static Long intersectAndStore(String key,Collection<String> otherKeys,String destKey){
        return RedisUtil.redisUtil.redisTemplate.opsForZSet().intersectAndStore(key, otherKeys, destKey);
    }
